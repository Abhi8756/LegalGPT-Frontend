              ...
              >
                {file ? (
                  <div className="flex items-center justify-center">
                    ...
                    <span className="text-gray-700 dark:text-white font-medium text-lg">{file.name}</span>
                  </div>
                ) : (
                  <div>
                    <svg
                    ...
                    <p className="text-gray-600 dark:text-gray-300 font-medium text-lg mb-2 text-center">Drag and drop your PDF contract here</p>
                    <p className="text-gray-500 dark:text-gray-400 text-sm text-center">or click to browse files</p>
                  </div>
                )}
              </label>
            </div>
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-gray-100 dark:bg-gray-700">
                    <th className="border-b border-r border-gray-200 dark:border-gray-600 p-4 text-left text-gray-700 dark:text-gray-200 font-semibold w-48">Status</th>
                    <th className="border-b border-r border-gray-200 dark:border-gray-600 p-4 text-left text-gray-700 dark:text-gray-200 font-semibold">Clause</th>
                    <th className="border-b border-r border-gray-200 dark:border-gray-600 p-4 text-left text-gray-700 dark:text-gray-200 font-semibold">Legal Rule</th>
                    <th className="border-b border-gray-200 dark:border-gray-600 p-4 text-left text-gray-700 dark:text-gray-200 font-semibold">Reason</th>
                  </tr>
                </thead>
                <tbody>
                  {Object.entries(complianceData).map(([, compliance], index) => (
                    <tr key={index} className="hover:bg-gray-50 dark:hover:bg-gray-700/70 transition-colors duration-150">
                      ...
                      <td className="border-b border-r border-gray-200 dark:border-gray-600 p-4 text-gray-700 dark:text-gray-300">{compliance.Clause}</td>
                      <td className="border-b border-r border-gray-200 dark:border-gray-600 p-4 text-gray-700 dark:text-gray-300">{compliance['Legal Rule']}</td>
                      <td className="border-b border-gray-200 dark:border-gray-600 p-4 text-gray-700 dark:text-gray-300">{compliance.Reason}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
