...
const dummyContent = [
  {
    ...
    description: (
      <>
        <p>
          Say goodbye to manual drafting! LegalGPT generates legally sound
  ...
  },
  {
    ...
    description: (
      <>
        <p>
          Avoid legal pitfalls before they happen. LegalGPT scans contracts to
    ...
    description: (
      <>
        <p>
          ...
          real-time regulatory checks. LegalGPT analyzes your contracts against
