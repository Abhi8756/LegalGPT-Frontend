        ...
        <div className="space-y-8 pr-0 md:pr-12 max-w-xl pt-30">
          ...
          <div className="space-y-6 text-muted-foreground pt-4">
            <div className="flex items-center space-x-4">
              ...
              <span className="text-lg font-medium">legalgpt@gmail.com</span>
            </div>
            <div className="flex items-center space-x-4">
              <div className="bg-primary/10 p-3 rounded-full">
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-7">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-7">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-foreground font-semibold text-base">Name</FormLabel>
                          <FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-foreground font-semibold text-base">Email</FormLabel>
                          <FormControl>
                            <div className="relative">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-foreground font-semibold text-base">Subject (Optional)</FormLabel>
                        <FormControl>
                          <Input
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-foreground font-semibold text-base">Message</FormLabel>
                        <FormControl>
                          <div className="relative">
